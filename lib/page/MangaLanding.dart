...
class _MangaLandingState extends State<MangaLanding> {
  Future<List<MangaUpdate>> mangas;

  Future<List<MangaUpdate>> getManga() async {
    List<MangaUpdate> list = [];
    String link = "http://52.66.213.188:9090/v1/manga/all?pageSize=10";
//    String link = "http://172.22.176.1:9090/v1/manga/all?pageSize=10";
